...
const baseTS = path.join(__dirname, "../templates/base-ts");
const baseJS = path.join(__dirname, "../templates/base");
...
const reduxRouterTs = path.join(__dirname, "../templates/redux-router-ts");
const reduxRouterJs = path.join(__dirname, "../templates/redux-router");
ts2js(baseTS, baseJS);
ts2js(reduxTS, reduxJS);
ts2js(routerTS, routerJS);
ts2js(reduxRouterTs, reduxRouterJs);